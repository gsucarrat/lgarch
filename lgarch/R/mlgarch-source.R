###########################################################
## This file contains the mlgarch source code
##
## First build/version: ??
##
...
mlgarchRecursion1 <- function(pars, aux)
{
  ...
  return(uadj)
} #end mlgarchRecursion1

#mlgarchRecursion1 <- cmpfun(mlgarchRecursion1)
